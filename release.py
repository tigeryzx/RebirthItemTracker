...
subprocess.call("python cxfreeze.py bootstrapper.py --base-name=Win32GUI --target-dir dist --icon ../mind.ico", shell=True, stdout=sys.stdout, stderr=sys.stderr)
os.chdir("..")
...
subprocess.call("python cxfreeze.py updater.py --base-name=Win32GUI --target-dir dist --icon ../mind.ico", shell=True, stdout=sys.stdout, stderr=sys.stderr)
os.chdir("..")
shutil.move('src_updater/dist/', installDir + "updater-lib/")

os.chdir("src")
subprocess.call("python cxfreeze.py item_tracker.py --base-name=Win32GUI --target-dir dist --icon ../mind.ico", shell=True, stdout=sys.stdout, stderr=sys.stderr)
os.chdir("..")
